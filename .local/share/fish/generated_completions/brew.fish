...
complete -c brew -l newer-only -d 'Show the latest version only if it[u2019]s newer than the formula/cask'
complete -c brew -l resources -d 'Also check resources for formulae'
complete -c brew -l extract-plist -d 'Include casks using the ExtractPlist livecheck strategy'
...
complete -c brew -l profile -d 'Run the test suite serially to find the n slowest tests'
...
complete -c brew -s h -l help -d 'Show this message.  OFFICIAL EXTERNAL COMMANDS alias [alias '
...
complete -c brew -l no-lock -d 'install does not output a Brewfile. lock. json'
