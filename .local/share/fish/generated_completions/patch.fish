...
complete -c patch -l backup-if-mismatch -d 'Save a backup copy of the file before it is modified, but only if a mismatch …'
complete -c patch -l no-backup-if-mismatch -d 'This option negates -backup-if-mismatch, creating backups for every file unle…'
...
complete -c patch -s g -d 'Causes patch to consult some version control systems for missing or read-only…'
complete -c patch -l help -d 'Print a help message and exit'
...
complete -c patch -l quoting-style -d 'Controls how patch writes out filenames to the console'
complete -c patch -s R -d 'Tells patch that this patch was created with the old and new files swapped'
complete -c patch -s T -d 'Tells patch to set the access and modification times of the output file based…'
...
complete -c patch -s Y -d 'Prepend prefix to the basename of the file to be backed up'
complete -c patch -s Z -d 'Tells patch to set the access and modification times of the output file based…'
