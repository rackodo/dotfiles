# git-svn
# Autogenerated from man page /opt/homebrew/share/man/man1/git-svn.1
...
complete -c git-svn -o 'T<trunk-subdir>' -l trunk -o 't<tags-subdir>' -l tags -o 'b<branches-subdir>' -l branches -s s -l stdlayout
...
complete -c git-svn -o 'R<remote-name>' -l svn-remote
