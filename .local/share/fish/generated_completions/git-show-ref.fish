# git-show-ref
# Autogenerated from man page /opt/homebrew/share/man/man1/git-show-ref.1
complete -c git-show-ref -l head -d 'Show the HEAD reference, even if it would normally be filtered out'
complete -c git-show-ref -l branches -l tags -d 'Limit to local branches and local tags, respectively'
...
complete -c git-show-ref -l heads -d 'is a deprecated synonym for'
