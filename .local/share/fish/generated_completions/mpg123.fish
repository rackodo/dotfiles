# mpg123
# Autogenerated from man page /opt/homebrew/share/man/man1/mpg123.1
...
complete -c mpg123 -l pauseloop -d 'Set the length of the loop interval in terminal control fixed looping mode, a…'
...
complete -c mpg123 -l libversion -d 'Print version information on the mpg123 libraries being used (libmpg123, libo…'
