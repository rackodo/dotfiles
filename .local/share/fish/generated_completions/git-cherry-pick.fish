# git-cherry-pick
# Autogenerated from man page /opt/homebrew/share/man/man1/git-cherry-pick.1
...
complete -c git-cherry-pick -l keep-redundant-commits -d 'Deprecated synonym for --empty=keep'
...
complete -c git-cherry-pick -l empty
