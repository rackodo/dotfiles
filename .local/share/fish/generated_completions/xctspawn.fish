# xctspawn
# Autogenerated from man page /usr/share/man/man1/xctspawn.1
...
complete -c xctspawn -l test-plan -d 'Specifies which test plan in the xctestproducts to run'
...
complete -c xctspawn -l disable-code-coverage -d 'If the tests were built with code coverage enabled, this option will skip the…'
