...
complete -c bundle-outdated -l strict -d 'Only list newer versions allowed by your Gemfile requirements'
...
complete -c bundle-outdated -l update-strict -d 'Strict conservative resolution, do not allow any gem to be updated past lates…'
